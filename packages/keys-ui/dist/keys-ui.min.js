...
`)||e.insert(`
`),e}function Q0(r,e,t){const n=t.query("code-block"),i=n&&"formats"in n&&typeof n.formats=="function"?n.formats(r,t):!0;return Wn(e,"code-block",i,t)}function Z0(){return new P}function X0(r,e,t){const n=t.query(r);if(n==null||n.blotName!=="list"||!gi(e,`
`))return e;let i=-1,s=r.parentNode;for(;s!=null;)["OL","UL"].includes(s.tagName)&&(i+=1),s=s.parentNode;return i<=0?e:e.reduce((a,o)=>o.insert?o.attributes&&typeof o.attributes.indent=="number"?a.push(o):a.insert(o.insert,{indent:i,...o.attributes||{}}):a,new P)}function J0(r,e,t){const n=r;let i=n.tagName==="OL"?"ordered":"bullet";const s=n.getAttribute("data-checked");return s&&(i=s==="true"?"checked":"unchecked"),Wn(e,"list",i,t)}function Ih(r,e,t){if(!gi(e,`
...
`,{[Le.blotName]:t}),i.insert(s)),new P);const n=this.quill.root.ownerDocument.createElement("div");return n.classList.add(Le.className),n.innerHTML=gw(this.options.hljs,t,e),bl(this.quill.scroll,n,[(i,s)=>{const a=vi.value(i);return a?s.compose(new P().retain(s.length(),{[rn.blotName]:a})):s}],[(i,s)=>i.data.split(`
